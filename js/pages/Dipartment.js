export default class DipartmentPage extends HTMLElement {
    connectedCallback() {
        ...
        this.innerHTML = `
          <ion-header translucent>
            <ion-toolbar>
              ...
              <ion-title>${dipartment}</ion-title>
            </ion-toolbar>
          </ion-header>
          ...
          <form name="semCGPA" id="sem-form">
            <ion-list>
              ${
              CGPA_Data[dipartment].S1.map((subject) => { return `
                <ion-item>
      ...
      CGPA_Data[dipartment].S1.forEach(sub => {
...
customElements.define("dipartment-page", DipartmentPage);